...
public abstract class AbstractBenchmarkClient {
    ...
    public void run(String[] args) throws Exception {
        ...
        final long endtime = System.nanoTime()/1000L + runtime * 1000 * 1000L; //毫微妙
        final int serviceId = Integer.parseInt(properties.getProperty("serviceid"));
        ...
        startInfo.append(",serviceId is: ").append(serviceId);
...
//        long beginTime = System.nanoTime() / 1000L;
        for (int i = 0; i < concurrents; i++) {
            ClientRunnable runnable = getClientRunnable(serverIP, serverPort, serviceId,requestSize, timeout, barrier, latch,
                                                        beginTime, endtime);
        ...
        System.out.println(" ServerId:" + serviceId);
    ...
    public abstract ClientRunnable getClientRunnable(String targetIP, int targetPort, int serviceId, int requestSize,int timeout,
